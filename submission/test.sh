...
# WRITE YOUR SOLUTION BELOW:
TREASURE_ADDR=$(bitcoin-cli -regtest -rpcwallet="treasurewallet" getnewaddress -addresstype legacy)
...
# WRITE YOUR SOLUTION BELOW:
LEGACY_ADDR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getnewaddress -addresstype legacy)
check_cmd "Legacy address generation"

P2SH_ADDR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getnewaddress -addresstype p2sh-segwit)
check_cmd "P2SH address generation"

SEGWIT_ADDR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getnewaddress -addresstype bech32)
check_cmd "SegWit address generation"

TAPROOT_ADDR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getnewaddress -addresstype bech32m)
...
# WRITE YOUR SOLUTION BELOW:
NEW_TAPROOT_ADDR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getnewaddress -addresstype bech32m)
...
# WRITE YOUR SOLUTION BELOW:
INTERNAL_KEY=$(echo "$ADDR_INFO" | jq -r '.desc' | sed -E 's/tr\(\[.*\]([a-f0-9]+)\).*/\1/')
